package main.java.models.ArvoreAVL;
...
public class ArvoreAVL<T> {
    ...
    public void Logs(String msg){
        try {
            ...
            fileWriter.write(msg + " -> " + "altura: " + altura(raiz));
